...
| I want to… | Go to |
|---|---|
| **edit a ChatGPT account reel, CODES or STUDENT variant** | [ChatGPT index](chatgpt/README.md) → [CODES learnings](chatgpt/variants/codes-phone-demo.md) / [STUDENT learnings](chatgpt/variants/student-offer-demo.md); variant rules override general camera defaults |
