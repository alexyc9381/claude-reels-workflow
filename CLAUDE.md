...
|---|---|---|---|
| storyboards | 77 | caption files | 126 |
...
| **review a DEPARTMENT-style revision or source/render mismatch** | [`memory/alex-department-source-and-motion-proof.md`](memory/alex-department-source-and-motion-proof.md) — source parity, causal follow-through, moving safe bounds and complete audio/encode evidence |
