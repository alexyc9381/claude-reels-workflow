...
| **review a DEPARTMENT-style revision or source/render mismatch** | [`memory/alex-department-source-and-motion-proof.md`](memory/alex-department-source-and-motion-proof.md) — explicit recreation rejection; concept changes across the whole film, different steady speeds per movement (mid-action ramps rejected), source parity, causal follow-through and honest technical evidence |
