#!/bin/zsh
# Reel 141 · DELIVERY to Drive, with the three checks that have failed silently before.
#   tools/gvt_deliver.sh <file> [<file> ...]      (each file must exist locally, non-empty)
#
# ⛔ Every deliverable goes in its OWN numbered folder, Faceless/141 - GRAVITY/. Never Trial Reels/.
...
set -u
D="$HOME/Library/CloudStorage/GoogleDrive-alexyc9381@gmail.com/My Drive/Claude Reels/Faceless/141 - GRAVITY"
