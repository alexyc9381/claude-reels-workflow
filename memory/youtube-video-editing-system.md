...
Current film revision: [V13](../youtube-video-editing-system/projects/higgsfield-replacement/REVISION-V13.md). Preserve V12's complete EDL/audio repairs. Faster causal intro actions; circular 1/2 identities below videos; center reveal countdown; hook face timer; single protected credential demonstration; stationary format text; operator-driven gate and explicit Seedance 2.5 selection; cursor click aligned with playback; clear free setup/copy-paste payoff. Claude Code/Codex/Cursor are workflow destinations, not verified universal installer compatibility. Check revision verification status. [Portable Mac resume prompt](../youtube-video-editing-system/projects/higgsfield-replacement/OTHER-MAC-HANDOFF-V13.md).
