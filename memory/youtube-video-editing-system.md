...
Current film revision: [V14](../youtube-video-editing-system/projects/higgsfield-replacement/REVISION-V14.md). Opening clips nearly fill the frame with slim margins; facecam overlays the lower center from frame zero; circular 1/2 badges sit inside the lower clip centers. This supersedes adding decorative elements below them. The next scene clearly contrasts the recorded monthly subscription example against a per-generation estimate without a false savings multiplier. Preserve all V13 EDL/audio/privacy/tutorial/reveal repairs. Claude Code/Codex/Cursor remain workflow destinations, not verified universal installers. [Portable Mac resume prompt](../youtube-video-editing-system/projects/higgsfield-replacement/OTHER-MAC-HANDOFF-V14.md).
