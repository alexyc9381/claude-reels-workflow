...
- Prepare seven reusable **audio-and-video** clips from the recording session. Audio-only splits do not satisfy this request. Preserve uncropped framing in the reusable synchronized masters and save a source cut/sync map for later edits.
