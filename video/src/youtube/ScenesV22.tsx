...
export const CostV22:React.FC<{duration:number;brandAt:number;bold?:boolean}>=({duration})=>{
 ...
 return <Set t={t}>
  ...
  <At x={1021} y={812} style={{width:345,textAlign:'center',fontWeight:850,fontVariantNumeric:'tabular-nums',color:'#275E4C',whiteSpace:'nowrap'}}><div data-price-block="per-generation" style={{height:74,display:'flex',justifyContent:'center',alignItems:'baseline',gap:5,lineHeight:1}}><span style={{fontSize:31,alignSelf:'center'}}>~</span><span style={{fontSize:74}}>10¢</span></div><div style={{fontSize:28,lineHeight:1.15,marginTop:6}}>per generation</div></At>
