...
const FPS = 30;
export const MISTAKE_TOTAL = 1338;             /* CUT 44.61s x 30fps */
...
export const L = {
  ...
  S1:  175,   /* SHADE   5.82s  "So here are three Claude mistakes..."           */
  S2:  258,   /* SCALE   8.60s  "First, stop telling Claude to act like..."      */
  S3:  386,   /* HOLD   12.88s  "Instead, spend those tokens telling Claude..."  */
  S4:  541,   /* MOUTH  18.02s  "Second, stop writing negative instructions..."  */
  S5:  637,   /* SLOTS  21.22s  "When you tell the model what not to do..."      */
  S6:  713,   /* SWAP   23.77s  "So say everything as a positive command..."     */
  S7:  822,   /* HITCH  27.39s  "Third, turn off automatic tool access."         */
  S8:  908,   /* RUN    30.27s  "Usually Claude loads all of your connectors..." */
  S9:  1069,  /* LOCKUP 35.63s  "Now go to your settings and switch tool..."     */
  S10: 1223,  /* DAY    40.76s  "I made a list of 15 mistakes to avoid..."       */
  END: MISTAKE_TOTAL,
} as const;
...
const HEAD: { at: number; big: string; hot: string }[] = [
  { at: L.S0,  big: "YOU ARE PAYING FOR",  hot: "AN EMPTY HOLD" },
  { at: L.S1,  big: "THREE THINGS TO",     hot: "TAKE OUT" },
  { at: L.S2,  big: "1 · THE COSTUME",     hot: "COSTS 31%" },
  { at: L.S4,  big: "2 · THE DON'T",       hot: "HAS NO DIRECTION" },
  { at: L.S7,  big: "3 · THE CHAIN",       hot: "RIDES EVERY TRIP" },
  { at: L.S9,  big: "THE SETTING",         hot: R.lever.on },
  { at: L.S10, big: "15 MISTAKES",         hot: "COMMENT MISTAKE" },
];
...
const BODY: Cue[] = [
  ...
  /* ---- S2 · THE WEIGH-IN. Four stepped pops, then the 0 seats. -------- */
  { at: S(L.S2 + 6),   src: "ratchet.wav",      v: LEVELS.SFX_MID,     dur: 1.0, rate: 0.84 },
  { at: S(L.S2 + 26),  src: "lamp_clunk.wav",   v: LEVELS.SFX_MID,     dur: 0.6, rate: 0.80 },
  { at: S(L.S2 + 38),  src: "lamp_clunk.wav",   v: LEVELS.SFX_MID,     dur: 0.6, rate: 0.92 },
  { at: S(L.S2 + 50),  src: "lamp_clunk.wav",   v: LEVELS.SFX_MID,     dur: 0.6, rate: 1.04 },
  { at: S(L.S2 + 62),  src: "lamp_clunk.wav",   v: LEVELS.SFX_MID,     dur: 0.6, rate: 1.16 },
  { at: S(L.S2 + 82),  src: "adv_strike.wav",   v: LEVELS.SFX_HERO,    dur: 1.2, rate: 0.88 },
  { at: S(L.S2 + 88),  src: "dead_thud.wav",    v: LEVELS.SFX_MID,     dur: 0.9, rate: 0.74 },

  /* ---- S3 · THE PAYOFF. The map, the clip, three ticks. --------------- */
  { at: S(L.S3 + 14),  src: "slate_whump.wav",  v: LEVELS.SFX_MID,     dur: 0.8, rate: 0.82 },
  { at: S(L.S3 + 22),  src: "can_bong.wav",   v: LEVELS.SFX_TEXTURE, dur: 1.1, rate: 1.10 },
  { at: S(L.S3 + 62),  src: "lamp_clunk.wav",   v: LEVELS.SFX_MID,     dur: 0.6, rate: 1.08 },
  { at: S(L.S3 + 86),  src: "blip2.wav",        v: LEVELS.SFX_TEXTURE, dur: 0.5, rate: 0.96 },
  { at: S(L.S3 + 104), src: "blip2.wav",        v: LEVELS.SFX_TEXTURE, dur: 0.5, rate: 1.06 },
  { at: S(L.S3 + 122), src: "blip2.wav",        v: LEVELS.SFX_TEXTURE, dur: 0.5, rate: 1.16 },
  { at: S(L.S3 + 130), src: "arrive_chime.wav", v: LEVELS.SFX_MID,     dur: 1.1, rate: 0.94 },
  ...
  /* ---- S5 · 2.53s, ONE idea, EXACTLY THREE cues. ---------------------- */
  { at: S(L.S5 + 26),  src: "chair_knock.wav",  v: LEVELS.SFX_MID,     dur: 0.7, rate: 0.90 },
  ...
  { at: S(L.S5 + 46),  src: "thock.wav",       v: LEVELS.SFX_HERO,    dur: 0.8, rate: 0.86 },
  { at: S(L.S5 + 60),  src: "dead_thud.wav",    v: LEVELS.SFX_MID,     dur: 0.9, rate: 0.72 },

  /* ---- S6 · THE SWAP, then the queue drains. -------------------------- */
  { at: S(L.S6 + 10),  src: "ratchet.wav",      v: LEVELS.SFX_MID,     dur: 0.9, rate: 1.02 },
  { at: S(L.S6 + 22),  src: "bamboo_crack.wav", v: LEVELS.SFX_MID,     dur: 0.8, rate: 0.92 },
  { at: S(L.S6 + 33),  src: "sign_clack.wav",   v: LEVELS.SFX_HERO,    dur: 1.0, rate: 0.96 },
  { at: S(L.S6 + 33),  src: "clap_slam.wav",    v: LEVELS.SFX_MID,     dur: 0.9, rate: 1.08 },
  { at: S(L.S6 + 46),  src: "blip4.wav",        v: LEVELS.SFX_TEXTURE, dur: 0.4, rate: 0.94 },
  { at: S(L.S6 + 61),  src: "blip4.wav",        v: LEVELS.SFX_TEXTURE, dur: 0.4, rate: 1.04 },
  { at: S(L.S6 + 76),  src: "blip4.wav",        v: LEVELS.SFX_TEXTURE, dur: 0.4, rate: 1.14 },
  { at: S(L.S6 + 91),  src: "arrive_chime.wav", v: LEVELS.SFX_MID,     dur: 1.0, rate: 1.10 },
  ...
  /* ---- S8 · FOUR PASSES, four gauge notches, the alarm on the last. --- */
  { at: S(L.S8 + 0),   src: "engine_idle.wav",     v: LEVELS.SFX_BED,     dur: 5.4, rate: 1.00 },
  { at: S(L.S8 + 2),   src: "gear_shift.wav",   v: LEVELS.SFX_MID,     dur: 0.9, rate: 0.96 },
  { at: S(L.S8 + 34),  src: "lamp_clunk.wav",   v: LEVELS.SFX_MID,     dur: 0.6, rate: 0.94 },
  { at: S(L.S8 + 40),  src: "gear_shift.wav",   v: LEVELS.SFX_MID,     dur: 0.9, rate: 0.90 },
  { at: S(L.S8 + 72),  src: "lamp_clunk.wav",   v: LEVELS.SFX_MID,     dur: 0.6, rate: 0.86 },
  { at: S(L.S8 + 78),  src: "gear_shift.wav",   v: LEVELS.SFX_MID,     dur: 0.9, rate: 0.84 },
  { at: S(L.S8 + 110), src: "lamp_clunk.wav",   v: LEVELS.SFX_MID,     dur: 0.6, rate: 0.78 },
  { at: S(L.S8 + 116), src: "motor_sag.wav",   v: LEVELS.SFX_MID,     dur: 0.9, rate: 0.78 },
  { at: S(L.S8 + 144), src: "alarm.wav",        v: LEVELS.SFX_MID,     dur: 1.5, rate: 0.90 },

  /* ---- S9 · THE PEAK. Lever, chain, five holes, the bell, the runner. - */
  { at: S(L.S9 + 10),  src: "knife_switch.wav", v: LEVELS.SFX_HERO,    dur: 1.0, rate: 0.88 },
  { at: S(L.S9 + 16),  src: "twang.wav",  v: LEVELS.SFX_MID,     dur: 1.2, rate: 0.80 },
  { at: S(L.S9 + 18),  src: "mech_clank.wav",   v: LEVELS.SFX_MID,     dur: 0.8, rate: 0.84 },
  { at: S(L.S9 + 42),  src: "mech_clank.wav",   v: LEVELS.SFX_MID,     dur: 0.8, rate: 0.92 },
  { at: S(L.S9 + 66),  src: "mech_clank.wav",   v: LEVELS.SFX_MID,     dur: 0.8, rate: 1.00 },
  { at: S(L.S9 + 90),  src: "mech_clank.wav",   v: LEVELS.SFX_MID,     dur: 0.8, rate: 1.08 },
  { at: S(L.S9 + 114), src: "mech_clank.wav",   v: LEVELS.SFX_MID,     dur: 0.8, rate: 1.16 },
  { at: S(L.S9 + 126), src: "bell_ring.wav",    v: LEVELS.SFX_HERO,    dur: 1.7, rate: 1.02 },
  { at: S(L.S9 + 134), src: "ratchet.wav",   v: LEVELS.SFX_MID,     dur: 0.9, rate: 0.94 },
  { at: S(L.S9 + 138), src: "arrive_chime.wav", v: LEVELS.SFX_HERO,    dur: 1.3, rate: 1.00 },
...
const BED: Record<Variant, string> = {
  kerb: "121mistake_bed.wav",
  rank: "121mistake_bed_rank.wav",
  gate: "121mistake_bed_gate.wav",
};
