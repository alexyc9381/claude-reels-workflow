...
function Shot({i}:{i:number}){const f=useCurrentFrame();const Comp=scenes[i];return <><Panel><Comp t={f/30*(i===4?41/50:1)}/><ClaudeContext i={i} t={f/30}/></Panel><HookHeader big={headers[i][0]} hot={i===3&&f<14?'A DIFFERENT WAY TO WORK':headers[i][1]} f={30}/></>}
...
registerRoot(()=> <><Composition id="WIN" component={WIN} durationInFrames={826} fps={30} width={1080} height={1920}/><Composition id="WIN-Cover" component={WINCover} durationInFrames={1} fps={30} width={1080} height={1920}/></>);
