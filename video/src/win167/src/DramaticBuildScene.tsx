...
export function Build({t}:{t:number}){
 ...
 const d={x:-38-16*burst,y:223+24*burst-18*strain,s:394,think:1-burst,cheer:0,rot:-9*strain-16*burst+7*land,cast:1-S(t,.1,.17)};
 const hs=118+302*surge,hx=568-158*surge+18*run,hy=709-hs*1.04-78*arc(t,.36,.66)+6*land;
 ...
 <Sprite t={t} x={hx} y={hy} s={hs} role={2} tint="#65A38D" boots={1} squash={land*.8} rot={-12*arc(t,.36,.66)+5*run} shock={.6*(1-surge)} cheer={surge}/>
 </>}
 ...
 <Charge t={t} at={0} dur={.28} {...quillTip(d)} s={.7}/><Bolt t={t} at={.19} from={quillTip(d)} to={{x:616,y:511}} dur={.2}/><Impact t={t} at={.33} x={648} y={559} s={1.7}/><Impact t={t} at={1.02} x={621} y={704} s={1.7}/>
