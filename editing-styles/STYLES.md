...
| **Illustrated Plates + Authored 2D** *(optional alternative)* | A tactile illustrated setting helps explain a narrated build, review or handoff; explicitly selected for the reel | Generated quiet scenery + original Claude, independent props, real marks and word-timed foreground actions; no image-to-video generation | [illustrated-plates.md](illustrated-plates.md) — SPLIT 161, alternative only |

**Optional alternative:** [Illustrated plates + authored 2D animation](illustrated-plates.md), documented from SPLIT 161 at Alex’s September 21 request. Generated still environments support independently animated original characters, real logos and meaningful code-native props. Select it intentionally; Cinematic Blueprint remains the default. SPLIT is a delivered reference with rejected iterations, not a measured winning pack. Its still-plate treatment is scoped to this option; do not silently impose it on other styles.
