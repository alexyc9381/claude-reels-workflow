...
variants={1:[(0,'impact','large magnet sweeps immediately'),(7,'clank','magnet catches plug swarm'),(13,'chain','rope pulls Claude across floor'),(24,'thock','Claude plants feet'),(34,'lever','Claude reclaims magnet'),(43,'clank','compression tool caught'),(49,'terminal','visibility tool caught'),(55,'key','access key caught'),(59,'coin','three tools jingle'),(70,'thock','rank platform rises'),(81,'pickup','crown lands'),(87,'coin','crown glint'),(99,'paper','handoff toward first tool')],2:[(0,'impact','oversized packet and charged launcher'),(4,'lever','packet fires'),(6,'paper','packet crosses foreground'),(15,'clank','clamp compresses packet'),(25,'terminal','visibility lens reveals strip'),(31,'key','access key turns'),(38,'unlock','gate opens'),(49,'thock','compression tool docks'),(59,'terminal','visibility tool docks'),(69,'key','access tool docks'),(76,'thock','completed relay lifts Claude'),(84,'pickup','rank crown arrives'),(91,'coin','rank glint'),(99,'paper','handoff toward first tool')]}
gains.setdefault('chain', -12.0)
