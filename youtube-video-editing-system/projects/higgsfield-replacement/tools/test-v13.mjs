...
assert.match(read('ScenesV9.tsx'),/FeatureVault=FeatureGateV13/);assert.match(read('ScenesV9.tsx'),/GuideV9=(FollowAlongV13|GuideV15)/);assert.match(read('ScenesV9.tsx'),/RoadmapV9=(RoadmapV13|RoadmapV15)/);
