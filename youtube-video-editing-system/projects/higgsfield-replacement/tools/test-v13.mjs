...
assert.match(read('ScenesV9.tsx'),/FeatureVault=(FeatureGateV13|FeatureGateV17|VaultV20)/);assert.match(read('ScenesV9.tsx'),/GuideV9=(FollowAlongV13|GuideV15|GuideV20)/);assert.match(read('ScenesV9.tsx'),/RoadmapV9=(RoadmapV13|RoadmapV15|RoadmapV16|RoadmapV18|RoadmapV19|RoadmapV20)/);
