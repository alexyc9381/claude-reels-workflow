...
const output=path.join(base,'outputs/higgsfield-replacement-edit-v10.mp4');
...
result.audioMatchesV9Packets=result.audioPacketHash===audioHash(path.join(base,'outputs/higgsfield-replacement-edit-v9.mp4'));
assert.equal(result.audioMatchesV9Packets,true,'No soundtrack change allowed in this picture-only revision');
writeFileSync(path.join(base,'work/higgsfield-replacement/revision-v10/export-validation.json'),JSON.stringify(result,null,2));console.log(JSON.stringify(result,null,2));
