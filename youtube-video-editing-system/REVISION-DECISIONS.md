...
Latest follow-up (V17): larger opening1/2 labels for small previews; full-scene Higgsfield visibility/size; quicker meaningful intro actions with fewer unrelated parts; rebuild54s usage limits,58s subscription X and1:18 premium access. Source review identified three different claims, so each gets a distinct physical mechanism. OBS/source cuts unchanged. [Request map, motion principles and verification](projects/higgsfield-replacement/REVISION-V17.md).

Latest follow-up (V11): improve ~0:13 access, ~2:43 credentials, ~4:38 rooftop action and ~7:36 closing; add source-anchored fal.ai steps near ~2:09; enlarge OBS within thinner margins; remove ~6:01 duplicate setup; restore ~6:15 playback through landing; eliminate the ~7:01 retake-adjacent lead-in; move bonus earlier with a gift/real countdown; enlarge reveal logos. New scenes use the original 2D outfits, room depth, physical response and beginning/action/payoff. Comparison footage stays large. [Full request-to-change table and verification](projects/higgsfield-replacement/REVISION-V11.md). Source timestamp changes are explicit; never treat feedback timestamps as permanent edit coordinates.
